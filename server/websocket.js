...
function addPluginRouter(config) {
  ...
  createAction(router, "/yapi-api/api", config.controller, config.action, routerPath, method, true);
}


function websocket(app) {
  createAction(router, "/yapi-api/api", interfaceController, "solveConflict", "/interface/solve_conflict", "get")
